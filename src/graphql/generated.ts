...
/**
 * __useQueryGamesExploreQuery__
 *
 * To run a query within a React component, call `useQueryGamesExploreQuery` and pass it any options that fit your needs.
 * When your component renders, `useQueryGamesExploreQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useQueryGamesExploreQuery(baseOptions?: Apollo.QueryHookOptions<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>(QueryGamesExploreDocument, options);
      }
export function useQueryGamesExploreLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>(QueryGamesExploreDocument, options);
        }
// @ts-ignore
export function useQueryGamesExploreSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>): Apollo.UseSuspenseQueryResult<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>;
export function useQueryGamesExploreSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>): Apollo.UseSuspenseQueryResult<QueryGamesExploreQuery | undefined, QueryGamesExploreQueryVariables>;
export function useQueryGamesExploreSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>(QueryGamesExploreDocument, options);
        }
export type QueryGamesExploreQueryHookResult = ReturnType<typeof useQueryGamesExploreQuery>;
export type QueryGamesExploreLazyQueryHookResult = ReturnType<typeof useQueryGamesExploreLazyQuery>;
export type QueryGamesExploreSuspenseQueryHookResult = ReturnType<typeof useQueryGamesExploreSuspenseQuery>;
export type QueryGamesExploreQueryResult = Apollo.QueryResult<QueryGamesExploreQuery, QueryGamesExploreQueryVariables>;
 ...
 * });
 */
export function useQueryGamesBySlugQuery(baseOptions?: Apollo.QueryHookOptions<QueryGamesBySlugQuery, QueryGamesBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
// @ts-ignore
export function useQueryGamesBySlugSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<QueryGamesBySlugQuery, QueryGamesBySlugQueryVariables>): Apollo.UseSuspenseQueryResult<QueryGamesBySlugQuery, QueryGamesBySlugQueryVariables>;
export function useQueryGamesBySlugSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<QueryGamesBySlugQuery, QueryGamesBySlugQueryVariables>): Apollo.UseSuspenseQueryResult<QueryGamesBySlugQuery | undefined, QueryGamesBySlugQueryVariables>;
...
// @ts-ignore
export function useQueryRecommendedSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<QueryRecommendedQuery, QueryRecommendedQueryVariables>): Apollo.UseSuspenseQueryResult<QueryRecommendedQuery, QueryRecommendedQueryVariables>;
export function useQueryRecommendedSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<QueryRecommendedQuery, QueryRecommendedQueryVariables>): Apollo.UseSuspenseQueryResult<QueryRecommendedQuery | undefined, QueryRecommendedQueryVariables>;
...
/**
 * __useQueryUpcomingQuery__
 *
 * To run a query within a React component, call `useQueryUpcomingQuery` and pass it any options that fit your needs.
 * When your component renders, `useQueryUpcomingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useQueryUpcomingQuery({
 *   variables: {
 *      date: // value for 'date'
 *   },
 * });
 */
export function useQueryUpcomingQuery(baseOptions: Apollo.QueryHookOptions<QueryUpcomingQuery, QueryUpcomingQueryVariables> & ({ variables: QueryUpcomingQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<QueryUpcomingQuery, QueryUpcomingQueryVariables>(QueryUpcomingDocument, options);
      }
export function useQueryUpcomingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QueryUpcomingQuery, QueryUpcomingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<QueryUpcomingQuery, QueryUpcomingQueryVariables>(QueryUpcomingDocument, options);
        }
// @ts-ignore
export function useQueryUpcomingSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<QueryUpcomingQuery, QueryUpcomingQueryVariables>): Apollo.UseSuspenseQueryResult<QueryUpcomingQuery, QueryUpcomingQueryVariables>;
export function useQueryUpcomingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<QueryUpcomingQuery, QueryUpcomingQueryVariables>): Apollo.UseSuspenseQueryResult<QueryUpcomingQuery | undefined, QueryUpcomingQueryVariables>;
export function useQueryUpcomingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<QueryUpcomingQuery, QueryUpcomingQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<QueryUpcomingQuery, QueryUpcomingQueryVariables>(QueryUpcomingDocument, options);
        }
export type QueryUpcomingQueryHookResult = ReturnType<typeof useQueryUpcomingQuery>;
export type QueryUpcomingLazyQueryHookResult = ReturnType<typeof useQueryUpcomingLazyQuery>;
export type QueryUpcomingSuspenseQueryHookResult = ReturnType<typeof useQueryUpcomingSuspenseQuery>;
export type QueryUpcomingQueryResult = Apollo.QueryResult<QueryUpcomingQuery, QueryUpcomingQueryVariables>;